...
<!-- 			<br/> -->
			<a href="companyRegistration"><p class="small">Company Registration</p></a>
			<!-- <a href="company/employeeLogin"><p class="small">Employee Login</p></a> -->
			<a href='${pageContext.request.contextPath}'><p class="small">Home</p></a>
		</div>
